  ...
  return (
    <section className="services-two">
      ...
      <div className="services-two__shape-1 float-bob-x">
        <img src={servimg1} alt="Service shape decoration" />
      </div>
      <div className="services-two__shape-2 float-bob-y">
        <img src={servimg2} alt="Service shape decoration" />
      </div>
          ...
          <ul className="services-two__services-list list-unstyled">
            {hoverItems.map((item) => (
              ...
              >
                ...
                >
                  <img src={item.image} className="hover-item__box-img" alt={item.title} />
                </div>
              </li>
            ))}
          </ul>
